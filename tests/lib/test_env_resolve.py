#!/usr/bin/env python3
# Vendored verbatim from on-the-record docs/specs/test-env-resolution.md
# (issue #551 reference implementation, gates/test_env_resolve.py).
# Adopted here per issue #22 — do not modify this module's logic; changes
# belong upstream in on-the-record.
