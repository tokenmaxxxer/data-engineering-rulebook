<!--
Repo-local mirror of the on-the-record canonical spec, fetched verbatim
from tokenmaxxxer/on-the-record docs/specs/test-env-resolution.md
(issue #551). Adopted in this repo's tests per issue #22. Do not edit the
convention itself here — changes belong upstream in on-the-record.
-->
